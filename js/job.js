...
$(document).ready(function () {
    $(window).scroll(function () {
        ...
        if (scroll > 50) {
            $(".navbarContainer").css("background", "white");
            $(".navbarContainer").css("top", "0");
            $(".navbarContainer").css("box-shadow","0 10px 11px rgba(0,0,0,0.4)");
            $(".navbarContainer a").css("color","black");
            ...
            $(".navbarContainer").css("top", "30px");
            $(".navbarContainer").css("box-shadow","0 0px 0px rgba(0,0,0,0.4)");
            $(".navbarContainer a").css("color","white");
